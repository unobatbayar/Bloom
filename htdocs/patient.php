...
while($row = $data->fetch_assoc()) {
    ...
    echo'<button type="submit" class="uk-background-muted uk-button uk-button-default uk-button-large uk-width-1-1"> Patient ID: '.$i.'<div class="uk-container uk-container-small uk-text-break">';
    ...
    echo '<div class="uk-text-small">Expecting baby: '.htmlspecialchars($row['baby_due_date'], ENT_QUOTES, 'UTF-8').' <div class="uk-text-emphasis">Born : '.htmlspecialchars($row['born'], ENT_QUOTES, 'UTF-8').'</div></br></br>';
